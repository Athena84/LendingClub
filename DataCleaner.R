...
selected_cols <- c("addr_state", "annual_inc", "dti", "emp_length", "fico_range_low", "fico_range_high", "grade", "id", "int_rate", "loan_amnt", "purpose", "sub_grade", "term", "issue_d", "loan_status")
cleaned_accepted <- accepted[ , selected_cols]

#Save cleaned data set
write.csv(accepted, "./data/cleaned_accepted.csv", row.names = FALSE)
